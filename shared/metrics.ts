/**
 * Reine, framework-freie Metrik-Funktionen — Single Source für App und Cloud Function (ADR-04).
 * Keine Abhängigkeiten zu React/Firebase/DOM, damit sowohl der Vite-Client als auch das
 * Functions-Backend dieselbe Logik importieren können (keine duplizierte Formel-Logik).
 */
